                ...
                {reports.map(r => (
                    <tr key={r.id}>
                        ...
                        <td className="border p-2 space-x-2">
                            <button onClick={() => banUser(r.reportedUserId)} className="px-2 py-1 bg-red-500 text-white rounded">Ban</button>
                            <button onClick={() => sendWarning(r.reportedUserId, r.reason)} className="px-2 py-1 bg-yellow-400 rounded">Warn</button>
                        </td>
                    </tr>
                ))}
                </tbody>
